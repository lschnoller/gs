		...
		<td>
			<table width="600" cellpadding="0" cellspacing="0" border="0" align="center">
				<tr>
					...
					<td width="1" >&nbsp;</td>
					<td width="149" style="background-color: #CBD0A9;" align="center"><a href="<?php echo base_url()?>mba" style="color: #FFF;font-family: 'Century Gothic';font-size: 15px;text-decoration: none;">QUE ES EL MBA</a></td>
					<td width="1" >&nbsp;</td>
